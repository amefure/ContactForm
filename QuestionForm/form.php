...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/Questionform/css/reset.css">
  <link rel="stylesheet" href="http://localhost/Questionform/css/style.css">
</head>
...
<body>
  <form class="form-container" method="post" action="form.php">
    <div class="radio-change">
      <p>お問い合わせ種別</p>
      <input type="radio" name="kinds" value="質問" id="radio1" <?php if (isset($kinds) && $kinds === "質問") {echo "checked";} else {echo "checked";} ?>><label for="radio1">質問</label>
      <input type="radio" name="kinds" value="依頼" id="radio2" <?php if (isset($kinds) && $kinds === "依頼") {echo "checked";} ?>><label for="radio2">依頼</label>
      <input type="radio" name="kinds" value="その他" id="radio3" <?php if (isset($kinds) && $kinds === "その他") {echo "checked";} ?>><label for="radio3">その他</label>
    </div>
    <p>お名前</p>
    ...
    <p>内容</p>
    <textarea type="text" name="body" placeholder="お問い合わせ内容" rows="7" required><?php if (isset($body)) {echo $body;} ?></textarea><button class="c-btn c-btn_form" type="submit" name="submit" value="確認">確認</button>
  </form>
</body>
